...
module.exports = {
  ...
  acl: [
    ...
    { name: '功能管理', url: '', code: 'GNGL', remark: '', createdBy: 0, updatedBy: 0, parentId: 1 },
    { name: '功能查询', url: 'get/acls', code: 'GNCX', remark: '', createdBy: 0, updatedBy: 0, parentId: 16 },
    { name: '功能新增', url: 'post/acls', code: 'GNXZ', remark: '', createdBy: 0, updatedBy: 0, parentId: 16 },
    { name: '功能修改', url: 'put/acls', code: 'GNXG', remark: '', createdBy: 0, updatedBy: 0, parentId: 16 },
    { name: '功能删除', url: 'delete/acls', code: 'GNSC', remark: '', createdBy: 0, updatedBy: 0, parentId: 16 },
    { name: '功能设置状态', url: 'post/setAclStatus', code: 'GNSZZT', remark: '', createdBy: 0, updatedBy: 0, parentId: 16 },
    { name: '用户功能', url: 'get/getUserAclTree', code: 'YHGN', remark: '', createdBy: 0, updatedBy: 0, parentId: 16 },
    { name: '用户权限码', url: 'get/getUserAclCodes', code: 'YHQXM', remark: '', createdBy: 0, updatedBy: 0, parentId: 16 },
    { name: '角色功能', url: 'get/getRoleAcls', code: 'JSGN', remark: '', createdBy: 0, updatedBy: 0, parentId: 16 },
